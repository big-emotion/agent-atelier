...
**Claude-code path credential rule (upstream Ferry ADR-0006 §6):** `CLAUDE_CODE_OAUTH_TOKEN`
...
| `ANTHROPIC_API_KEY` | Provider key for the bundled-script agent loop | script path only — **forbidden on claude-code** (upstream Ferry ADR-0006 §6) |
